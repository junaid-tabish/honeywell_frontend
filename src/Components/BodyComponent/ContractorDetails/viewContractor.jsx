    ...
    <h3>View Contractor</h3>
      ...
      <div className="view">
        <Card className="Viewcard"    sx={{ padding: 5, border: "3px solid gray", boxShadow: "0px 6px 8px 2px rgba(38, 37, 37, 0.51)" }}>
          <CardMedia>
            <center><Avatar className="avatar">C</Avatar></center>
          </CardMedia>
          <CardContent>
            <center>
            ...
            <Typography variant="body2" color="text">
              <ul>
                <li> Contractor Name : {values && values.name}</li>
                <li> Email :{values && values.email} </li>
                <li> Role : {values && values.role}</li>
                {/* <li> Password : {distributorData && distributorData.password}</li> */}
              </ul>
            </Typography>
          </CardContent>
          <CardActions>
